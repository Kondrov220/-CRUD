...
var _getJs1 = require("./form/get.js");
var _delateJs = require("./api/delate.js");
// import { updateIceCreamApi } from "./api/updateIceCreamApi.js";
var _updateJs = require("./form/update.js");
(0, _getJs.getStudents)().then((data)=>{
    console.log(data);
    document.querySelector("tbody").innerHTML = (0, _markUpJs.makeList)(data);
});
(0, _getJs1.collectModalInfo)(document.querySelector("#add-student-form"));
// Операція видалення
document.querySelector("tbody").addEventListener("click", async (event)=>{
    if (event.target.textContent === "Delete") {
        ...
        console.log(item);
        console.log(item.id);
        await (0, _delateJs.deleteStudent)(item.id);
...
},{}],"hS0rU":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lQH2V":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "collectModalInfo", ()=>collectModalInfo);
var _getJs = require("../api/get.js");
var _postJs = require("../api/post.js");
var _markUpJs = require("../markUp/markUp.js");
const collectModalInfo = (form)=>{
    form.addEventListener("submit", async (e)=>{
        ...
        await (0, _postJs.post)(newStudent);
        const updatedList = await (0, _getJs.getStudents)();
        document.querySelector("tbody").innerHTML = (0, _markUpJs.makeList)(updatedList);
        form.reset(); // Очистити форму
    });
};

},{"../api/get.js":"daUFG","../api/post.js":"hxyJD","../markUp/markUp.js":"hS0rU","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hxyJD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "post", ()=>post);
const post = async (iceCream)=>{
    const options = {
        method: "POST",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7SvX3","kyksZ"], "kyksZ", "parcelRequire42a0", {})

//# sourceMappingURL=-CRUD.d29bb997.js.map
